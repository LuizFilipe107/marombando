...
//BUSCAR DADOS DO GRÁFICO
	include_once("global/ciselect.php");
?>
...
<html>
	...
	<body class="bgimg">
		...
		<div class="row" style="text-align:center">
			<div class="btn-group btn-group" role="group" aria-label="group button">
				<a href="ialunos.php" class="btn btn-lg btn-warning" role="button">
				<span class="glyphicon glyphicon-chevron-left" aria-hidden="true"></span> Voltar</a>
			</div>
		</div>
<div class="container-fluid">
	<div style="margin: 2%" class="container-fluid">
		
		<div class="row">
			<div class="col-md-3" >
				<h2 class="simplemsg"><span class="glyphicon glyphicon-stats" aria-hidden="true"></span> Geral</h2>
				<h4><span class="simplemsg"><span class="glyphicon glyphicon-user" aria-hidden="true"></span>  Aluno:  </span><span><?php echo $nomA ?></span></h4>
				<h4><span class="simplemsg"><span class="glyphicon glyphicon-calendar" aria-hidden="true"></span> Última Avaliação: </span><span><?php echo $dataAV; if(!$dataAV){echo "-";};?></span></h4>
			...
			<div class="col-md-6" >
				...
				<div>
				<h4><span class="simplemsg"><span class="glyphicon glyphicon-heart-empty" aria-hidden="true"></span> Atual: </span><span><?php echo $aUltp." kg" ?></span></h4>
				<h4><span class="simplemsg"><span class="glyphicon glyphicon-calendar" aria-hidden="true"></span> Em: </span><span><?php echo $datU ?></span></h4>
